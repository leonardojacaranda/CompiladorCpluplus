...
// Porque 5? tamanho maximo das regras a direita
Dados vetor[5]; //
int contador;
    ...
    if (regra.var_esq=="P"){
        ...
        if(regra.var_esq=="ES"){
            if(regra.prd_dir=="leia id ;"){
                ...
                if(tip=="literal"){
                    ...
                    cout<<"Erro4: Variavel nao declarada"<< linha <<" coluna: " <<coluna << "\n";//botar a linha
                    exit(0);
            }else{
        ...
        if(regra.var_esq=="ARG"){
            ...
            if(vetor[0].token==IDENTIFICADOR){
                ...
                if(flag==1){
                    ...
                    cout<<"Erro3: Variável nao declarada"<< linha <<" coluna: " <<coluna << "\n";
                    exit(0);
                }
            }
        }
            ...
            if(vetor[3].token==IDENTIFICADOR){
                for (it = tabelaSimbolos.begin(); it != tabelaSimbolos.end(); it++ ){
                    if(it->lexema==vetor[3].lexema&&it->token==vetor[3].token){
                        flag=1;
                        aux=it->tipo; //podem ter o mesmo nome porém com tipos diferentes
                        break;
                    }
                }
                if(flag==1){
                    if(aux==vetor[1].tipo){
                        ...
                        cout<<"Erro: Tipos diferentes para atribuicao"<< linha <<" coluna: " <<coluna << "\n";
                        exit(0);
                    }
                }else{
                    cout<<"Erro2: Variável nao declarada"<< linha <<" coluna: " <<coluna << "\n";
                    exit(0);
                }
            }
        }
        if(regra.var_esq=="LD"){
            if(vetor[0].tipo==vetor[2].tipo&&vetor[1].token!=LITERAL){
                stringstream Resultado; //pega um inteiro e transforma em string
                Resultado << contador;//variavel global
                contador++;
        ...
        if(regra.var_esq=="OPRD"){
            if(vetor[0].token==IDENTIFICADOR){
                ...
                if(flag==1){
                    ...
                    cout<<"Erro1: Variável nao declarada"<< linha <<" coluna: " <<coluna << "\n";
                    exit(0);
                }
            }else{
                naoterm=vetor[0];
        ...
        if(regra.var_esq=="EXP_R"){
            if(vetor[0].tipo==vetor[2].tipo){
              ...
              return naoterm;
                ...
                cout << "Erro: Operandos com tipos incompativeis"<< linha <<" coluna: " <<coluna << "\n";
                exit(0);
            }
        }
